...
ui <- fluidPage(
  ...
  navbarPage(title="Evento Unical",
             tabPanel("Studiare Statistica all'UNICAL",
                      ...
                      tags$img(src="locandina.jpg",height="800", width="550",align="left")#,style="display: block; margin-left: auto; margin-right: auto;")
                      #img(src='locandina.jpg', align = "right")
             ...
             tabPanel("Mi presento",
                      ...
                      tags$img(src="Io.jpg", height="300",width="250"),
                      h3("-Marco Cortese"),
                      h3("-28 anni"),
                     ...
                     #), 
                      ...
                      tags$img(src="https://rstudio.com/wp-content/uploads/2014/04/shiny.png?width=200",height="50", width="50"),#style="display: block; margin-left: auto; margin-right: auto;")
                      ...
                      tags$img(src="https://upload.wikimedia.org/wikipedia/commons/3/37/Plotly-logo-01-square.png",height="50", width="170"),#style="display: block; margin-left: auto; margin-right: auto;")
                      ...
                      tags$img(src="https://www.betterbuys.com/wp-content/uploads/2016/08/Qlik.png",height="100", width="120"),#style="display: block; margin-left: auto; margin-right: auto;")
                      h2("Tools"),
